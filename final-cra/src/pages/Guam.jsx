  ...
  const aboutData = [
    {
      ...
      description: 'DIF괌은 4만여 평 규모의 워터파크 내에서 70여 가지의 각종 레저와 스포츠를 무료로 즐길 수 있는 종합 휴양 리조트로 777개의 객실을 갖춘 괌 최대의 특급호텔입니다.',
      bigFontColor: 'pink',
      ...
      description: '일본 전통 라면, 미국식 현대 코스요리, 뷔페까지 DIF의 7개 레스토랑에서 전 세계 다양한 음식들을 즐겨보세요.',
      bigFontColor: 'orange',
      ...
      description: '남국의 자연과 멋을 살려 지어진 광대한 DIF의 워터파크에서 지루할 틈 없는 액티비티들을 즐겨보세요. 전 세계 8개뿐인 인공 수족관에서 형형색색의 열대 물고기들과 수영을 해보는 신기한 체험과 하늘을 향해 날아오르는 트램폴린은 강력 추천!',
      bigFontColor: 'blue',
      bigFontContent: 'FREE'
    }
  ]
  ...
  const notifiData = [
    {
      ...
      list: [
        { id: 1, listTitle: '모든 쿠폰은 체크인 시 객실당 1장 제공되며, 양도/재사용 / 재발급 / 현금화가 불가합니다.' },
        { id: 2, listTitle: '본 혜택은 3박 이상 예약 고객에 한해 제공됩니다.' },
        { id: 3, listTitle: '공항 송영서비스 제공을 위해 예약 시 항공편명 및 시간을 적어주시기 바랍니다. (미기재 시 이용불가)' },
        { id: 4, listTitle: 'F&B $40 쿠폰은 객실당 1장 제공되며 한 장소에서 1회 사용할 수 있으며, 차액은 자동 소멸됩니다.' },
        { id: 5, listTitle: '무료 음료 쿠폰은 (1) 박당 성인수만큼 제공합니다.' },
        { id: 6, listTitle: '무료 룸 업그레이드는 체크인 시 확인 가능하며, 객실 상황에 따른 것으로 사전 확인 및 보장이 불가합니다.' },
        { id: 7, listTitle: '무료 룸 업그레이드는 시헤키, 패밀리 디럭스 객실에는 적용되지 않으며 디럭스 객실에서 로얄클럽으로 업그레이드되는 경우 라운지서비스는 제공되지 않습니다.' },
        { id: 8, listTitle: 'DIF 괌 $100 상품권을 제외한 나머지 혜택은 투숙 기간 내에만 사용이 가능합니다.' },
        { id: 9, listTitle: 'CCP 장비 무료 대여 쿠폰은 게스트 서비스 데스크에서 골프 예약 진행 시 지참하셔야 사용이 가능합니다.' },
        { id: 10, listTitle: '모든 쿠폰은 분실 및 도난시 재발급이 불가하오니 유의해 주시기 바랍니다.' },
      ]
    }, {
      id: 2,
      title: 'DIF 괌 $100 상품권',
      list: [
        { id: 1, listTitle: '7박 이상을 예약하시는 경우 DIF괌 $200상품권이 제공됩니다.' },
        { id: 2, listTitle: '체크인 시 객실당 1장 제공되며, 양도/재사용/재발급/현금화가 불가합니다.' },
        { id: 3, listTitle: '예약자명으로만 발행되며, 예약자이자 투숙객인 본인이 재방문 시 사용 가능합니다.' },
        { id: 4, listTitle: '여러 객실 예약 시 각 객실 투숙객의 명의로 발행이 필요한 경우, 각 객실의 실투숙객의 영문명으로 예약해주시기 바랍니다.' },
        { id: 5, listTitle: '체크아웃 일자 기준 이후 3년간 유효합니다.' },
        { id: 6, listTitle: '공식 홈페이지를 통한 예약에 한해 사용이 가능합니다.' },
        { id: 7, listTitle: '본 상품권은 투숙일 3일 이상, 예약 건당 1장만 사용할 수 있습니다.' },
        { id: 8, listTitle: '본 상품권은 얼리버드, 타임세일 프로모션 등의 할인 상품과 중복적용 되지 않습니다.' },
      ]
    }, {
      id: 3,
      title: 'T 갤러리아 퍼스널 뷰티 예약 서비스',
      list: [
        { id: 1, listTitle: 'DBB를 예약하신 후 받으신 예약확정 이메일 하단에 명시되어 있는 T-갤러리아 링크에서 뷰티 예약 시간을 사전에 예약하실 수 있습니다.' },
        { id: 2, listTitle: 'T-갤러리아내에 있는 화장품 및 향수 관련 문의 및 퍼스널 쇼핑을 도와드립니다.' },
      ]
    }
  ]
  const serviceData = [
    {
      ...
      list: [
        ...
        { id: 4, listTitle: '지불방식 : 미화(현금, 여행자 수표), 카드 (아멕스, 비자, JCB, 마스터, 다이너스)' },
      ]
    }, {
      id: 2,
      icon: `${guestIcon}`,
      ...
      list: [
        ...
        { id: 2, listTitle: '서비스 내용 : 기념일 서비스(24시간 전 레스토랑 예약)' },
      ...
      list: [
        ...
        { id: 2, listTitle: '무선인터넷 이용 시 객실번호, 투숙객 성(LAST NAME) 입력' },
      ]
    }, {
      id: 4,
      icon: `${congratsIcon}`,
      ...
      title: '기념일 축하 서비스',
      list: [
        { id: 1, listTitle: '생일/결혼기념일: 프런트나 게스트서비스 카운터에 최소1일 전 신청필수.' },
        { id: 2, listTitle: '레스토랑에서 점심, 저녁식사 시 케이크 제공 (테이크아웃, 객실전달 불가합니다.)' },
      ]
    }, {
      id: 5,
      icon: `${roomIcon}`,
      ...
      title: '커넥팅룸 신청 서비스',
      list: [
        { id: 1, listTitle: '두 개의 객실을 내부에서 문으로 연결, 한 객실처럼 이용' },
        { id: 2, listTitle: '예약 시 요청하면 당일 객실 상황에 따라 객실 배정- 사전보장서비스 (비수기 예약만 가능) : 예약완료 후 출발 전 5~7일 사이에 예약과 (reservations@DIFguam.com) 혹은 “확정예약 문의게시판”을 통해 가능 여부를 별도로 문의, 가능한 경우 1박당 $30의 추가 비용 발생' },
      ]
    }, {
      id: 6,
      icon: `${iceIcon}`,
      ...
      title: '휠체어',
      list: [
        { id: 1, listTitle: '프런트 혹은 게스트서비스카운터에 요청 시 대여(무료)' },
      ]
    }, {
      id: 8,
      icon: `${strollerIcon}`,
      ...
      title: '유모차',
      list: [
        { id: 1, listTitle: '프런트 데스크에 요청 시 $25보증금 룸 차지후 이용 가능' },
      ]
    }, {
      id: 9,
      icon: `${transIcon}`,
      ...
      title: '식수대',
      list: [
        { id: 1, listTitle: '워터파크 곳곳에 설치되어 있음(무료)' },
      ]
    }, {
      id: 13,
      icon: `${tubeIcon}`,
    ...
    <>
      ...
      <SmoothScroll>
        <StyledGuam className='changeBg'>
          ...
          <BuildingLayout>
            <img src={require('assets/images/map-guam.png')} alt="괌 리조트 지도" />
          </BuildingLayout>
          <MarqueeText>
            <strong>dobby islands free</strong><em>guam</em><strong>dobby islands free</strong><em>guam</em><strong>dobby islands free</strong><em>guam</em>
          </MarqueeText>
          <TableContainer>
                    ...
                    return (
                      <tr key={tableItem.id}>
                        ...
                        <td>
                          ...
                          <Link to="/"><span className='a11y-hidden'>상세정보</span></Link>
                        </td>
                      </tr>
                    )
                  })
          ...
          <StyledDbbContainer>
            ...
            <SectionDesc>
              한국 공식 홈페이지 3박 이상 예약 고객만을 위한 특별 혜택 끝판왕! DIF괌의 엄선된 혜택들을 한 곳에 모아 선보입니다. <br />
              DBB프로그램으로만 제공되는 혜택 누리시면서 완벽한 여행을 완성해 보시기 바랍니다. <br />
              ※DBB 혜택은 예약 건마다 적용되며, 최소 3박 이상인 예약에만 제공되는 점 유의해 주시기 바랍니다.
            </SectionDesc>
            <StyledDbbBox>
          ...
          <StyledServiceContainer>
            <SectionTitle>
              잊지 못할 최상의 서비스를 제공합니다
            </SectionTitle>
            <SectionDesc>
              24시간 프런트 데스크를 운영하며, 기념일 서비스, 유모차 및 휠체어 대여 서비스 등이 준비되어 있습니다.<br />
          ...
          <StyledCCPContainer>
            <SectionTitle>
              DIF가 추천하는 괌 골프 코스 CCP괌!
            </SectionTitle>
            <SectionDesc>
              CCP괌은 괌 최남단에 위치한 18홀 챔피언십 골프 코스입니다.<br />
              산과 계곡이 적절히 배치되어있는 쉽지 않은 코스로 CCP는 괌 골퍼들에게 오랫동안 사랑받고 있습니다.
            </SectionDesc>
            <SectionDesc>
              모든 코스들이 남태평양과 조화를 이루고 있어 인생샷을 남기기도 최고인 이 곳!<br />
              CCP괌 공식 홈페이지 혹은 DIF 로비에 위치한 게스트서비스 카운터에서 예약을 하실 경우<br />
              6가지 이상의 특별 혜택을 받으실 수도 있으니<br />
