...
export const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (termsOfUse === false || termsOfPersonalInfo === false || termsOfAge === false) {
  ...
  return (
    <StyledSection onSubmit={handleSubmit}>
      ...
      <UserSignUpInput name={"password"} type={"password"} placeholder={"비밀번호를 입력해주세요."} onChange={handleChangeInput} required>
        비밀번호
      </UserSignUpInput>
