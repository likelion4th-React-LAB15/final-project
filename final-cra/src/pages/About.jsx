        ...
        <StyledAbout className="changeBg">
          ...
          <StyledBottomPadding>
            <ClosingContents>
              ...
              <ClosingTitle>
                <ClosingTitleLine>DIF</ClosingTitleLine>{' '}
                <ClosingTitleBold>CARES Program</ClosingTitleBold>
              </ClosingTitle>
              <ClosingDesc>
                도비 아일랜드 프리는 코로나바이러스감염증-19(COVID-19)로 인한
                재난 상황에 대해 PIC케어(CARES) 프로그램을 통한 모든 시설에 대한
                청결, 소독, 안전조치를 시행하고 있습니다.
              </ClosingDesc>
              <ClosingDesc>
                DIF케어(CARES) 프로그램은 강화된 청결과 소독 조치를 통해
                투숙객과 직원들의 안전을 목표로 합니다.
              </ClosingDesc>
              <ClosingSubDesc>
                ◈ 저희 리조트는 의료용 소독 제품을 사용합니다. 모든 화학 물질,
                세척 제품 및 각 절차는 미국환경보호청(EPA),
                식품의약품안전청(FDA), ServeSafe® 및 질병관리본부(CDC)가 정한
                지침을 준수합니다.
              </ClosingSubDesc>
            </ClosingContents>
          </StyledBottomPadding>
